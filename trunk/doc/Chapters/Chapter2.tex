...
\begin{figure}[htbp]
	...
	\rule{35em}{0.5pt}
	\caption[Vector method]{The viewing field of a surveillance camera on a building is being visualized using the arrow method. The arrows' ends are indicated by blue dots, the arrows' heads are not drawn for clarity. The user's position is indicated by the green dot.}
...
Using the scene model, we can render visual aids in various modes as described in the next section.
